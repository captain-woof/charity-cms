...
export const Link = ({ id, href, children, style }: ILink) => {
    return (
        <LinkNext href={href}>
...
export const LinkBlock = ({ id, href, children, style }: ILink) => {
    return (
        <LinkNext href={href}>
...
export const LinkExternal = ({ id, href, children, style }: ILink) => {
    return (
